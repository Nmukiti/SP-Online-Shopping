...
import com.example.spshopping.Model.Cart;
import com.example.spshopping.Prev.Prev;
import com.example.spshopping.ViewHolder.CartViewHolder;
        ...
        FirebaseRecyclerOptions<Cart> options =
                new FirebaseRecyclerOptions.Builder<Cart>()
                        .setQuery(cartListRef.child("User view")
                                .child(Prev.currentOnlineUser.getPhone()).child("Products"),Cart.class).build();
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                if (i==1){
                                    cartListRef.child("User view")
                                            .child(Prev.currentOnlineUser.getPhone())
                                            .child("Products")
                                            .child(model.getPid())
                                            .removeValue()
